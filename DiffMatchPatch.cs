...
namespace DiffMatchPatch
{
    ...
    public class Diff
    {
        ...
        /// </summary>
        /// <param name="operationOne">of INSERT, DELETE or EQUAL.</param>
        ...
        /// </summary>
        /// <param name="d">Another Diff to compare against.</param>
    ...
    public class diff_match_patch
    {
        ...
        ///      bool values.</returns>
        public (string, bool[]) patch_apply(List<Patch> patches, string text)
        {
            if (patches.Count == 0)
            {
